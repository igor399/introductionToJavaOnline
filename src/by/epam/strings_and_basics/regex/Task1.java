package by.epam.strings_and_basics.regex;
...
public class Task1 {
	...
	public static void main(String[] args) throws IOException {
		String text = "Первый абзац. В этом абзаце три предложения. Три предлодения! \n"+
				 ...
				 "Шестой абзац. Одно предложение шестого абзаца.";

		textOperation(text);
	}
	
	private static void textOperation(String text) throws IOException {
