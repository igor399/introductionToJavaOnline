...
import by.epam.task6.library.entity.Catalog;
import by.epam.task6.library.entity.Letter;
...
public class CatalogUtil {
	...
	public static String getBookLine(Book book) {
		...
		return String.format("%s, \"%s\", %d year, type: %s", book.getAuthor(), book.getTitle(), book.getYear(),
