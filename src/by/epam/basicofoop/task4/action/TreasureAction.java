package by.epam.basicofoop.task4.action;
...
import by.epam.basicofoop.task4.Main;
import by.epam.basicofoop.task4.entity.*;
...
public class TreasureAction {
	...
	public List<Treasure> fillCaveWithTreasures(int numberOfTreasure) {
		...
		try {
			FileReader fileReader = new FileReader("D:\\Workspace\\JavaOnlineTrainig\\jonlinepractice05\\src\\by\\epam\\jonlinepract\\basicofoop\\task4\\data\\treasures_list.txt");
